...
class Test_User:
    ...
    def test_user_ra_is_none(self):
        ...
        User(name="VITOR", email="dev@maua.br",ra=None, state=STATE.APPROVED, course=COURSE.CIC, year=1, role=ROLE.USER, organization=ORGANIZATION.DEV, user_id=f"{uuid.uuid4()}")
