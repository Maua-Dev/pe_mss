import json
from src.modules.get_warning.app.get_warning_presenter import lambda_handler


class Test_GetWarningPresenter:

    def test_get_warning_by_id_presenter(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
        ...
        assert body["warnings"][0]["warning"]["warning_id"] == "e6112d17-c030-4d65-8b9f-e472d20055a5"
        assert body["message"] == "The warning/s was/were retrieved successfully"

    def test_get_warning_by_role_and_organization_presenter(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
        ...
        for warning_wrapper in body["warnings"]:
            ...
            assert warning["target_role"] == "PRESIDENT"
            # Should be either general (no org) or specific to DEV
            if warning["target_org"] is not None:
                assert warning["target_org"] == "DEV"

    def test_get_warning_presenter_without_user_from_authorizer(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
    ...
    def test_get_warning_presenter_without_parameters(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
    ...
    def test_get_warning_by_role_and_organization_nawat_presenter(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
        ...
        for warning_wrapper in body["warnings"]:
            ...
            assert warning["target_role"] == "PRESIDENT"
            if warning["target_org"] is not None:
                assert warning["target_org"] == "NAWAT"
