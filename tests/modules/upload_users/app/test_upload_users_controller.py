...
import pytest
from src.modules.upload_users.app.upload_users_controller import UploadUsersController
from src.modules.upload_users.app.upload_users_usecase import UploadUsersUsecase
from src.shared.helpers.external_interfaces.http_models import HttpRequest
from src.shared.infra.repositories.user_repository_mock import UserRepositoryMock


class Test_UploadUsersController:
    ...
    def test_upload_users_controller_without_user_from_authorizer(self):
        ...
        controller= UploadUsersController(usecase=usecase)
