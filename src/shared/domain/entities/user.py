...
# eu nao coloquei o body pois se nao, ele ia quebrar na hora de passar da forma como esta no banco para a classe ao utilizar os metodos do pydantic
class User(BaseModel):
    ...
    ra: str | None= Field(
        description="RA da mauá do usuário",
        default=None
    )
    ...
    state: STATE | None= Field(
        description="Estado do usuário em relação a comprimento de horas",
        default=None
    )
    ...
    year: int | None= Field(
        description="Ano da Mauá do usuário",
        default=None
    )

    active: ACTIVE | None= Field(
        description="Estado do usuário em relação a estar participando da entidade",
        default=None
    )

    organization: ORGANIZATION | None= Field(
        description="Entidade que o usuário faz parte",
        default=None
    )
